...
ui <- fluidPage(
  ...
  navbarPage("",
             tabPanel("Intro",
                      h2("Background"),
                      p("In just the past century, the world has seen massive technological advancements, not just on a global scale but on a consumer level as well. While technology increased productivity and communication across the planet, it also became highly integrated in people's personal lives. The 1980s saw the popularization of video games which has since cemented itself in the everyday life of people across the planet. Today, global video game sales settle in the hundred-millions yearly. As video game lovers, we are interested in investigating the trends of video game using this opportunity from info201."),
                      h2("Data"),
                      p("The dataset we used is from Kaggle and focuses on video games since the 1980s. It contains data on", nrow(vgsales), "individual games and includes relevant information like year, platform, genre, publisher, and sales (both global and regional)."),
                      h2("Intentions"),
                      p("For the purposes of this project, the data will be used to display and summarize trends over time and across genre. Our goal is to provide a visual representation of these trends both in a general informative context but also as a potential marketing resource for video game producers as we consider what factors may display the longest and more profitable trends."),
          ...
          Users are able to explore the platform as they wish!"),
             ...
             tabPanel("Summary",
                      ...
                      p("The quality of the data is considerably good as it contains a huge amount of samples. We think that it gives unbiased results as all the data is quantitative. It is also produced accordingly to VGChartz that doesn't seem to be associated with any gaming companies. Although the data might disadvantage some small game developing companies, the data can be used by interested gamers, game developers, and statisticians. Future projects can dig deeper into specific games."))
  )
)
